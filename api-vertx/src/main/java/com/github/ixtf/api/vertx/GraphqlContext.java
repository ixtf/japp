...
@Slf4j
public class GraphqlContext implements ApiContext {
    ...
    public GraphqlContext(Message reply, GraphQL graphQL, DataFetchingEnvironment env, Optional<Tracer> tracerOpt, String operationName) {
        this.reply = reply;
